...
class CNN():
    ...
    def __init__(self, input_dim=(1, 28, 28),hidden_size=256, output_size=10):
        ...
        self.layers.append(layer.Convolution(self.params['W5'], self.params['b5'], conv_param3['stride'], conv_param3['pad'])) # 10
        self.layers.append(layer.Relu())
        self.layers.append(layer.Convolution(self.params['W6'], self.params['b6'], conv_param4['stride'], conv_param4['pad'])) #12
        self.layers.append(layer.Relu())
        self.layers.append(layer.MaxPooling(pool_h=2, pool_w=2, stride=2))
